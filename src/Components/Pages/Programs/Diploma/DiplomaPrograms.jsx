  ...
  const loadPrograms = async (pageNumber = 1, reset = false) => {
    ...
    try {
      const params = new URLSearchParams({
        perPage: 18,
        page: pageNumber,
        program_level_id: 4, // Diploma/Certificate level
      });
  ...
  return (
    <div className="container py-5">
      ...
      <div className="text-center mb-4">
        <h1 className="fw-bold display-6">Diploma / Certificate Programs</h1>
        <p className="text-muted">
          Discover diverse diploma and certificate programs for your journey.
        </p>
      </div>
